...
class Speech() :
    def __init__(self) :
        ...
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="/Users/jeongjin-uk/jjw-mac-python/KISTI/kisti_final/kisti_final_project/fiery-splice-271513-fe3b54cc3d6a.json"
        print('start speech!')
    ...
    def sample_recognize(self, local_file_path) :
        ...
        #local_file_path = '/Users/choejuwon/Desktop/posco_flask/fileshello.wav'
